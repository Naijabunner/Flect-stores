...
const App = () => {
  ...
  ////Fetching data for cart items number
  ...
  const handleDocumentclick = (e) => {
    e.target.parentElement.className === "ham_nav"
      ? SetnavIsvisible((nav) => !nav)
      : SetnavIsvisible(false);
  };

  ///Getting all picked items id 
  ////No use ...Just got it for getting sake
  const allPickedId = [];
